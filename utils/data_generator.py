import numpy as np
import torch
from utils.trans import torch_to_numpy
...
class DataGenerator:
    ...
    def run_traj(self, env, policy, value_net, cvalue_net, running_stat,
        ...
        return {'states':self.obs_buf, 'actions':self.act_buf,
                ...
                'avg_cost': avg_cost, 'std_cost': std_cost,
                'avg_eps_len': avg_eps_len, 'n_episode': self.n_eps,
                'cum_cost': cum_cost, 'n_interact': n_interact
                }
